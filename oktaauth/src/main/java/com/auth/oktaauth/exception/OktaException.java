package com.auth.oktaauth.exception;
 ...
 */
public class OktaException extends AuthenticationException{
	...
	public OktaException(String message, String code, String detail) {
		super(message);
		errorCode = code;
