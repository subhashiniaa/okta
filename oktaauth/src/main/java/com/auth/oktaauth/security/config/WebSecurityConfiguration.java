...
import com.auth.oktaauth.security.filter.RestAccessDeniedHandler;
import com.auth.oktaauth.security.filter.SecurityAuthenticationEntryPoint;
...
//    @Autowired
//	private OktaJwtAuthenticationFilter awsCognitoJwtAuthenticationFilter;
...
//				.addFilterBefore(awsCognitoJwtAuthenticationFilter, UsernamePasswordAuthenticationFilter.class);
    ...
    private com.auth.oktaauth.security.filter.CorsFilter corsFilter() {
        /*
        ...
        */
        ...
        return new com.auth.oktaauth.security.filter.CorsFilter();
    }
}
